...
import 'models/Pessoa.dart'; //import model class
import 'dart:io';
import 'dart:async';
...
class MemoDbProvider{
  ...
  // Read
  Future<List<Pessoa>> fetchMemos() async{ //returns the memos as a list (array)

    final db = await init();
    final maps = await db.query("Pessoa"); //query all the rows in a table as an array of maps
  ...
  // Update
  Future<int> updateMemo(int id, Pessoa item) async{ // returns the number of rows updated
